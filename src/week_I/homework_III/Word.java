...
public class Word implements Comparable<Word> {
	...
	protected int count; // the number of occurance of the string
	protected int total; // the cumulative score for all the sentence in which the said string appears
