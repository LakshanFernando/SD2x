...
public class PlagiarismDetector {
	...
	protected static List<String> readFile(String filename) {
		...
		// the change from LinkedList to ArrayList enables faster retrieval via index
	...
	/*
	 * Returns an int for the number of matches that occur in both of the Set parameters.
	...
	protected static int findMatches(Set<String> myPhrases, Set<String> yourPhrases) {
        ...
        if (myPhrases != null && yourPhrases != null) {
            ...
            if (myPhrasesList.size() != 0 && yourPhrases.size() != 0) {
